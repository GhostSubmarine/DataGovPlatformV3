	...
	<div style="padding-left: 20px;">
		<el-tabs>
			...
			<el-tab-pane v-if="canStandard">
			  ...
			  <div>
				<CleanLog ref="cleanLogRef" hasMetadataId="1"></CleanLog>
			  </div>
			</el-tab-pane>
		</el-tabs>
...
import CleanLog from '../data-standard-clean-log/index.vue'
...
const init = (data: any) => {
	...
	setTimeout(()=>{
		if(canStandard.value) {
			//获取清洗配置
			addOrUpdateRef.value.init(data.id)
			//清洗日志
			cleanLogRef.value.init(data.id)
		}
	},200)
}
